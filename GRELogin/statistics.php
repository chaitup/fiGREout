...
<div >
<h1 style='margin-top:20px;'> <img  src='images/logo_pic_white.png'></img></h1>
</div>
...
font :13px verdana;
  ...
  var  NumberCorrectQuantitative =       <?php echo $NumberCorrectQuantitative ?>, 
	   NumberCorrectMultipleOneAnswer =  <?php echo $NumberCorrectMultipleOneAnswer ?>, 
	   NumberCorrectMultipleMoreAnswer = <?php echo $NumberCorrectMultipleMoreAnswer ?>, 
	   NumberCorrectNumericEntry  =     <?php echo $NumberCorrectNumericEntry ?>,
	   
	   NumberAnsweredQuantitative =       <?php echo $NumberAnsweredQuantitative - 1 ?>,
	   NumberAnsweredMultipleOneAnswer =  <?php echo $NumberAnsweredMultipleOneAnswer - 1 ?>,
	   NumberAnsweredMultipleMoreAnswer=  <?php echo $NumberAnsweredMultipleMoreAnswer -1  ?>,
	   NumberAnsweredNumericEntry=        <?php echo $NumberAnsweredNumericEntry -1 ?>;
		
	var TotalCorrect =    <?php echo  $TotalCorrect ?>,
	    TotalWrong   =    <?php echo  $TotalWrong ?>;
  ...
  <p class='informationbox'>Use the below chart to quickly determine which questions you are best at, and which question you should study for. Questions that you have answered correctly less than 30% of the time are colored RED, questions that you've answered correctly 30-60% of the time are colored BLUE, and questions that you've answered correctly more than 60% of the time are colored GREEN.</p>
        ...
        <div id="bardataholder" style="margin-top:10px;width:450px;height:300px;-webkit-transform:rotate(0deg);display:inline-block;vertical-align:top;padding:30px;">
	     ...
	     <div style="padding:20px;font-family:'segoe UI';font-size:15px;border-bottom:1px solid #eee;">
		  <p style="font-size:25px;">Distribution</p><br/>
		 </div>
	     <div style="padding:20px;font-family:'segoe UI';font-size:15px;border-bottom:1px solid #eee;">
